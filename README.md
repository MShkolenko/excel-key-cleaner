...
перехватывается). 37 входных строк × 8 наборов флажков сверяются с эталонной моделью на Python (запускается на
...
python tests\verify.py out            # ожидается: mirror agreement: 296 OK, 0 MISMATCH; invariants: all OK
