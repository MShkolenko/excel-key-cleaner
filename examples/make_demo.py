...
ROWS = [
    ...
    ('Пробелы по краям', '  XX.U1.ABC.0003  ', 'XX.U1.ABC.0003', 'края чистятся ВСЕГДА, при любых флажках'),
    ...
    ('Скрытая строка - тоже чистится', 'XX.U1.ABС.0009', 'XX.U1.ABC.0009', 'строка скрыта; в отчёте будет посчитана как скрытая'),
    ('Разное оформление символов - чистится, оформление сохраняется', 'rich', 'rich', 'первая буква жирная и останется жирной'),
]
